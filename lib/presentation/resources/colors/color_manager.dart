...
class ColorManager {
  ...
  static const Color backgroundColor = Color(0xff040404);
  ...
  static const Color lightGreyWithOpacity_10 = Color(0x1ABFBCAF);
  static const Color cloud = Color(0xff757b88);
  static const Color lightCloud = Color(0xff78868a);
  static const Color errorColor = Color.fromARGB(255, 153, 151, 57);
